  ...
  return (
    <aside className="room-sidebar" box-="square">
      ...
      <div className="room-sidebar__section">
        ...
        <div className="room-sidebar__value room-sidebar__room-id">{room.name}</div>
        <div className={`room-sidebar__status room-sidebar__status--${room.status.toLowerCase()}`}>
      ...
      <div className="room-sidebar__section">
        ...
        <div className="room-sidebar__row">
          ...
          <span className="room-sidebar__value room-sidebar__temp">{room.T.toFixed(1)} K</span>
        </div>
        <div className="room-sidebar__row">
          <span className="room-sidebar__key">T_death</span>
          <span className="room-sidebar__value">{room.T_death.toFixed(1)} K</span>
        </div>
        <div className="room-sidebar__row">
      ...
      <div className="room-sidebar__section">
        ...
        <div className="room-sidebar__row">
          ...
          <span className="room-sidebar__value">
            ~{room.estTimeToDeathHours}h {String(room.estTimeToDeathMinutes).padStart(2, "0")}m
          </span>
        </div>
        <div className="room-sidebar__row">
          <span className="room-sidebar__key">your cost</span>
          <span className="room-sidebar__value">{room.nextMsgFuCost.toFixed(3)} FU/msg</span>
        </div>
      </div>
      ...
      <div className="room-sidebar__section">
        ...
        <div className="room-sidebar__row">
          ...
          <span className="room-sidebar__value">
            {room.lifespanHours}h {String(room.lifespanMinutes).padStart(2, "0")}m
          </span>
        </div>
        <div className="room-sidebar__row">
          <span className="room-sidebar__key">peak T</span>
          <span className="room-sidebar__value">{room.peakTemp.toFixed(1)} K</span>
        </div>
        <div className="room-sidebar__row">
          <span className="room-sidebar__key">grace</span>
          <span className="room-sidebar__value room-sidebar__grace-expired">expired</span>
        </div>
      </div>
      ...
      <div className="room-sidebar__section">
        ...
        <div className="room-sidebar__pulse-value">{room.platformPulse} msg/min</div>
        <div className="room-sidebar__row">
